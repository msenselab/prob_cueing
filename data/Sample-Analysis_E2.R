#################################################################################
### Sample Analysis for MS-ASP-LT Experiment 2                      #############
#################################################################################
#################################################################################
...
# --------------------------------------------------
# subject_nr                numeric   subject identifier (unique)
...
#
# Note: Blocks are coded like in E1
#       Session 1: 1,2,3,4
#       Session 2: 1,2,3,4
data <- read.table(file="data_LT_E2.csv", sep=",", dec=".", head=TRUE)
...
test <- DIFF_SESSION_1 # THIS IS CURRENTLY TESTED
